function [X_manpg, F_manpg,sparsity,time_manpg,iter_adap,flag_succ,num_linesearch,mean_ssn,F,time_arr]  = manpg_orth_sparse_adap(B,option)
...
for iter = 2:maxiter
    ...
    if  F_trial < option.opt + 1e-4 || normDsquared/t^2 < tol 
        break;
    end
