function [X_manpg, F_manpg,sparsity,time_manpg,iter,flag_succ,num_linesearch,mean_ssn,F,time_arr] =manpg_CMS(H,option,d_l,V)
...
for iter = 2:maxiter
    ...
    if  normDsquared/t^2 < tol  ||  F(iter - 1)<=option.F_mialm + 1e-4
