function [X_manpg, F_manpg,sparsity,time_manpg,iter,flag_succ,num_linesearch,mean_ssn] = manpg_orth_sparse1(B,option)
...
for iter = 2:maxiter
    ...
    if  normDsquared/t^2 < tol || F(iter -1)<=option.opt
